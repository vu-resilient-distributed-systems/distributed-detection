...
from worker_thread_fns import receive_images,send_messages,receive_messages,load_balance
...
def worker(hosts,ports,worker_num, timeout = 20, VERBOSE = True):
    ...
    p_average_time = random.random() # for storing worker average proc time
